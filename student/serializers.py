...
class ChapterDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chapter
        fields = ['id', 'chapter_name', 'chapter_description', 'duration_minutes', 'duration_hours', 'video_url', 'quizzes']
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'who_is_this_course_for', 'course_requirements', 'number_of_modules', 'number_of_chapters', 
            'purchased', 'duration'
        ]
    ...
    def get_duration(self, obj):
        total_minutes = calculate_course_duration(obj)
